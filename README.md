...
- Control access to resources using google groups instead of individual accounts and use Service Accounts where applicable. For all the server-to-server interactions, use service accounts. For example, avoid - - -
- Automatic IAM permissions for default service accounts and Ability to create service accounts in a production environment.
